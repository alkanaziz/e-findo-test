...
const Sidebar = () => {
  ...
  // İki aşamalı animasyon için isVisible state'ini kullan
  useEffect(() => {
    let timeout;
    if (isOpen) {
      setIsVisible(true);
    ...
    <div className="relative">
      ...
      {isVisible && (
        ...
        >
          ...
          {/* Menü İçeriği */}
          <nav className="flex h-full md:h-[calc(100vh-12rem)] flex-wrap *:max-w-28 justify-evenly md:justify-between gap-3 p-3 *:rounded-lg *:border *:border-e-brown-400 md:flex-nowrap md:flex-col">
